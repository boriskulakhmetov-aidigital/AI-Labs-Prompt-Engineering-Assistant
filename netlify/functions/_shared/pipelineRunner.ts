...
import { PROMPT_DESIGN_SYSTEM_PROMPT, PROMPT_REVISION_SYSTEM_PROMPT } from './promptDesignPrompt.js';
import { PROMPT_TESTER_SYSTEM_PROMPT } from './promptTesterPrompt.js';
import { PROMPT_ENGINEER_SYSTEM_PROMPT } from './promptEngineerPrompt.js';
import { TEST_INPUT_GENERATOR_PROMPT } from './testInputPrompt.js';
...
export async function runPipeline(body: PipelineJobRequest): Promise<void> {
  const { submission, jobId, userId, userEmail, messages } = body;
